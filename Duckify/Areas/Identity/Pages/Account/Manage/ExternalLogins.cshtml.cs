...
namespace Duckify.Areas.Identity.Pages.Account.Manage {
    public class ExternalLoginsModel : PageModel {
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync() {
            ...
            if (!result.Succeeded) {
                var error = result.Errors.FirstOrDefault(x => x.Code == "LoginAlreadyAssociated");
                if (error != default) {
                    StatusMessage = $"This {info.LoginProvider} account is associated with different account.";
                } else {
